#!/bin/bash -l
# scripts/submit_inference_dump_swin_label_alpha.sh
#
# Same as submit_inference_dump_swin.sh but for the label-x-alpha retrained
# Swin UNETR checkpoint (checkpoints/swin_unetr_label_alpha/best_model.pth,
# trained 8/1 with --scale_label_by_alpha -- see
...
#
# Submit with:  qsub scripts/submit_inference_dump_swin_label_alpha.sh
