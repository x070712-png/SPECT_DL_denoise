#!/bin/bash -l
# scripts/hpc/generate_data/submit_dataset.sh
#
# Generates the 500-phantom ellipsoidal dataset via generate_dataset.py,
# as an SGE array job (100 tasks, 5 phantoms per task).
#
# Submit with: qsub scripts/hpc/generate_data/submit_dataset.sh
