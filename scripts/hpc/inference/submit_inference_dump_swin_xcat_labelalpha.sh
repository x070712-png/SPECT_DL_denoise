#!/bin/bash -l
# scripts/hpc/inference/submit_inference_dump_swin_xcat_labelalpha.sh
#
...
#
# Submit with: qsub scripts/hpc/inference/submit_inference_dump_swin_xcat_labelalpha.sh
