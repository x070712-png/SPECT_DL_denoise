#!/bin/bash -l
# scripts/submit_inference_earl_v2_unet.sh
#
...
# sphere_conc=126.457/background_conc=84.4954, job 110057, that fixes the
...
#
# Submit with: qsub scripts/submit_inference_earl_v2_unet.sh
